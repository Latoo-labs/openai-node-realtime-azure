...
class OpenAIRealtimeWS extends internal_base_1.OpenAIRealtimeEmitter {
    constructor(props, client) {
        ...
        this.url = (0, internal_base_1.buildRealtimeURL)(client, props.model, props.transcription);
    ...
    static async azure(client, options = {}) {
        ...
        return new OpenAIRealtimeWS({ model: deploymentName, transcription, options: { headers: await getAzureHeaders(client) } }, client);
    }
    send(event) {
        try {
